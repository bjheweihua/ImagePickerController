...
@interface UIGifPhotoPreviewController () {
    
    UIToolbar *_toolBar;
    UIButton *_doneButton;
    UIJRProgressView *_progress;
...
@implementation UIGifPhotoPreviewController
...
- (void)configBottomToolBar {
    ...
    byteLable.font = [UIFont systemFontOfSize:14];
    byteLable.frame = CGRectMake(10, 0, 100, 44);
    [[UIImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
